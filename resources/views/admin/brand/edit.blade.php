...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Edit Brand Details</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route("dashboard") }}">Home</a></li>
                <li class="breadcrumb-item "><a href="{{ route("brand") }}">Brand List</a></li>
                <li class="breadcrumb-item active">Edit Brand Details</li>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                ...
                <form action="{{ route('update.brand',$details['id']) }}" method="post">
                    @csrf
                    @method('PUT')
                  ...
                  <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ $details->name }}" name="name" class="form-control"  placeholder="Enter Brand name">
                        @error('name')
