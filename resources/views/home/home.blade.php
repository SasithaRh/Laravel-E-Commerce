                                    ...
                                    <div class="intro-slide">
                                        <figure class="slide-image">
                                            <picture>
                                                ...
                                                <img src="{{ asset('storage/upload/sliders/' . $detail->image) }}" alt="Image Desc">
                                            </picture>
                                        </figure><!-- End .slide-image -->

                                        <div class="intro-content">
                                            <h3 class="intro-subtitle">{{ $detail->title }}</h3><!-- End .h3 intro-subtitle -->
                                            <h1 class="intro-title">{{ $detail->sub_title }}</h1><!-- End .intro-title -->
