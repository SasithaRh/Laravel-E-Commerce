        			...
        			<div class="col-6 col-lg-4">
        				<div class="banner banner-display banner-link-anim">
                			...
                			<div class="banner-content banner-content-center">
                				...
                				<a href="{{ $category->slug }}" class="btn btn-outline-white banner-link">Shop Now<i class="icon-long-arrow-right"></i></a>
                			</div><!-- End .banner-content -->
            			</div><!-- End .banner -->
                            ...
                            @endphp
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-11 mt-v3 text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{{ asset('storage/upload/products/' .$getproductimage->image_name) }}" alt="Product image" class="product-image">
                                        ...
                                        <div class="product-body">
                                            <h3 class="product-title"><a href="product.html">{{ $allproducts->title }}</a></h3><!-- End .product-title -->
                                            <div class="product-price">
                        ...
                        @endphp
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-11 mt-v3 text-center">
                                        ...
                                        <div class="product-body">
                                            <h3 class="product-title"><a href="product.html">{{ $getproductbycat->title }}</a></h3><!-- End .product-title -->
                                            <div class="product-price">
